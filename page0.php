...
<html lang="fr" dir="ltr">
  ...
  <body>
    ...
    unlink($page);
    /* try {
      $db = new PDO('mysql:host=localhost;dbname=ministre', 'ministre', 'Famous21', [PDO::ATTR_ERRMODE => PDO::ERRMODE_EXCEPTION]);
     } catch (Exception $e) {
       die('Erreur :' . $e->getMessage());
     }
     $q ='INSERT INTO salles(nom) Values(:titre)';
   	$req = $db->prepare($q);
   	$reponse = $req -> execute([
   	 'titre' => $titre
   ]);*/
...
<form action="branche1.php" method="post">
